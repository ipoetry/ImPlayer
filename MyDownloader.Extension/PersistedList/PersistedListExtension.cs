...
namespace MyDownloader.Extension.PersistedList
{
    public class PersistedListExtension: IExtension, IDisposable
    {
        ...
        private const int SaveListIntervalInSeconds = 60;
        ...
        public void PersistList(object state)
        {
        ...
        {
            string file = Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath) + "\\" + "downloads.dat";
            return file;
        }
        //MARK

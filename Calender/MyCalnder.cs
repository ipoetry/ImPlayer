...
namespace ImPlayer
{
        ...
        /// <summary>
        /// 中国农历V1.0 支持1900.1.31至2049.12.31日止的数据,来自网络
        /// </summary>
        public class Calendar
        {
            ...
            public Calendar(int cy, int cm, int cd, bool leapMonthFlag)
            {
                     ...
                     (cm < leap)) //计算月份小于闰月     
                {
                    ...
                    {
                        throw new CalendarException("不合法的农历日期");
                    }
            ...
            private void CheckDateLimit(DateTime dt)
            {
                ...
                {
                    throw new CalendarException("超出可转换的日期");
                }
            }
            #endregion
            ...
            private void CheckChineseDateLimit(int year, int month, int day, bool leapMonth)
            {
                ...
                {
                    throw new CalendarException("非法农历日期");
                }
                if ((month < 1) || (month > 12))
                {
                    throw new CalendarException("非法农历日期");
